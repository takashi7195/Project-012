...
test("one Gemini request returns classification and both short reply candidates", async () => {
  ...
  assert.equal(request.body.system_instruction.parts[0].text, "通常はすっとぼけたアホキャラの、あほっぽい口調で、ため口でなれなれしく返答してください。競艇に関する内容には非常に詳しく答えてください。疑問形や質問で終わらず、返信の中で内容を完結させてください。");
